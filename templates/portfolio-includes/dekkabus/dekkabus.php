<?php
	...
	/**
	 * Template include: [Portfolio] Dekkabus: Dekkabus landing
	 *
...
?>
	...
	<header class="u-clearfix  o-header--portfolio  o-header--portfolio--dekkabus">
		...
		<div class="c-portfolio-header__content">
			...
			<h3 class="c-portfolio-header__descriptor">Classic bus hire for Hampshire, Dorset and Southern England with vintage, authentic English buses.</h3>
