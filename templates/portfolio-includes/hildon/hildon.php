<?php
	...
	/**
	 * Template include: [Portfolio] Hildon: Hildon landing
	 *
...
?>
	...
	<header class="u-clearfix  o-header--portfolio  o-header--portfolio--hildon">
		...
		<div class="c-portfolio-header__content">
			...
			<h3 class="c-portfolio-header__descriptor">A refreshingly pure Natural Mineral Water found in leading retailers and exclusive venues renowned for its taste and purity.</h3>
